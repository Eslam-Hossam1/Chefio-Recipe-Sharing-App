...
class LocalNotificationsService {
  ...
  Future<void> showBasicNotification(
    ...
    bigPictureStyleInformation = await getNotificationImage(remoteMessage, bigPictureStyleInformation);
  ...
  Future<BigPictureStyleInformation?> getNotificationImage(RemoteMessage remoteMessage, BigPictureStyleInformation? bigPictureStyleInformation) async {
