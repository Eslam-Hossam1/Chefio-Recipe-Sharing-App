...
import 'package:chefio_app/features/upload_recipe/presentation/view/widgets/upload_second_step_page/enter_step_item.dart';
        ...
        return Padding(
          ...
          child: SlideTransition(
            ...
            child: Dismissible(
              ...
              direction:
                  uploadRecipeCubit.uploadRecipeFormModel.steps.length < 3
